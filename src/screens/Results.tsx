...
export function Results({ game, identity, players, payments, weekResults }: ResultsProps) {
    ...
    <div className="flex items-center justify-center gap-4 p-4 overflow-x-auto">
      ...
      <div className="shrink-0">
        <Android className="drop-shadow-2xl">
                ...
                <WAMessageIn sender="Grupalia">
                  ...
                  <div className="flex justify-around mb-3">
                    <div className="text-center">
                      <p className="text-xl font-bold font-mono text-ok-600">
                        {weeksPassed}
                      </p>
                    ...
                    <div className="text-center">
                      <p className="text-xl font-bold font-mono text-g-900">
                        {totalWeeks}
                      </p>
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              {p.role === "presidenta" && (
                                <Badge variant="presidenta" className="ml-1.5">
                                  Presidenta
                                </Badge>
                              )}
          ...
          {activeApp === "grupalia" && localPlayer && (
            <GrupaliaApp
              game={game}
